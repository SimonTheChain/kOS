...
FUNCTION BURN {
	...
	IF USE_RCS = True {
		...
		SET BurnStartDv TO NdDeltaV.
		UNTIL StageEngine:THRUST >= StageEngine:AVAILABLETHRUST {
			MONITOR().
		}.
		GLOBAL EngineDv IS BurnStartDv - NdDeltaV.
	}
